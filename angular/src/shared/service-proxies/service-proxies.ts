...
export class CountryServiceProxy {
     ...
     * @return Success
     */
    getAllCountry(filter: string | undefined, countryNameFilter: string | undefined, sorting: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<GetCountryForViewDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/Country/GetAllCountry?";
        if (filter === null)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<GetCountryForViewDtoPagedResultDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<GetCountryForViewDtoPagedResultDto>;
        }));
    }

    protected processGetAllCountry(response: HttpResponseBase): Observable<GetCountryForViewDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = GetCountryForViewDtoPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<GetCountryForViewDtoPagedResultDto>(null as any);
    }
    ...
    protected processGetCountryForEdit(response: HttpResponseBase): Observable<GetCountryForEditOutput> {
        ...
        return _observableOf<GetCountryForEditOutput>(null as any);
    }
    ...
    protected processGetCountryForView(response: HttpResponseBase): Observable<GetCountryForViewDto> {
        ...
        return _observableOf<GetCountryForViewDto>(null as any);
    }
}
...
export class StateServiceProxy {
     ...
     * @return Success
     */
    getAllState(filter: string | undefined, stateNameFilter: string | undefined, countryId: number | undefined, sorting: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<GetStateForViewDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/State/GetAllState?";
        if (filter === null)
            throw new Error("The parameter 'filter' cannot be null.");
        else if (filter !== undefined)
            url_ += "Filter=" + encodeURIComponent("" + filter) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetAllState(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<GetStateForViewDtoPagedResultDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<GetStateForViewDtoPagedResultDto>;
        }));
    }

    protected processGetAllState(response: HttpResponseBase): Observable<GetStateForViewDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = GetStateForViewDtoPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<GetStateForViewDtoPagedResultDto>(null as any);
    }
    ...
    protected processGetStateForEdit(response: HttpResponseBase): Observable<GetStateForEditOutput> {
        ...
        return _observableOf<GetStateForEditOutput>(null as any);
    }
    ...
    protected processGetStateForView(response: HttpResponseBase): Observable<GetStateForViewDto> {
        ...
        return _observableOf<GetStateForViewDto>(null as any);
    }
}
...
export class GetCountryForViewDtoPagedResultDto implements IGetCountryForViewDtoPagedResultDto {
    items: GetCountryForViewDto[] | undefined;
    totalCount: number;

    constructor(data?: IGetCountryForViewDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): GetCountryForViewDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new GetCountryForViewDtoPagedResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): GetCountryForViewDtoPagedResultDto {
        const json = this.toJSON();
        let result = new GetCountryForViewDtoPagedResultDto();
        result.init(json);
        return result;
...
export interface IGetCountryForViewDtoPagedResultDto {
    items: GetCountryForViewDto[] | undefined;
    totalCount: number;
}
...
export class GetStateForViewDtoPagedResultDto implements IGetStateForViewDtoPagedResultDto {
    items: GetStateForViewDto[] | undefined;
    totalCount: number;

    constructor(data?: IGetStateForViewDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): GetStateForViewDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new GetStateForViewDtoPagedResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): GetStateForViewDtoPagedResultDto {
        const json = this.toJSON();
        let result = new GetStateForViewDtoPagedResultDto();
        result.init(json);
        return result;
...
export interface IGetStateForViewDtoPagedResultDto {
    items: GetStateForViewDto[] | undefined;
    totalCount: number;
}
