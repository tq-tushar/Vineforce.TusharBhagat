...
{
    public abstract class TusharBhagatWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static TusharBhagatWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(TusharBhagatWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<TusharBhagatDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<TusharBhagatDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<TusharBhagatDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<TusharBhagatDbContext, Task<T>> func)
        {
            T result;
