...
namespace Vineforce.TusharBhagat.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = TusharBhagatConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(TusharBhagatDbContext context)
        {
            _context = context;
        }
